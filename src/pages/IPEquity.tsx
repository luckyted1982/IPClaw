...
import { ChevronRight, Send, Loader2, Bot, User, Sparkles, Trash2, PieChart, Users, Scale, Handshake, TrendingUp, FileText, ShieldCheck, Building2, BookOpen } from 'lucide-react'
...
const EXAMPLE_QUERIES = [
  "我们的核心技术专利想作价入股新公司，怎么操作？占股比例怎么定？",
  "技术入股可以享受什么税收优惠政策？递延纳税怎么申请？",
  "投资人对IP尽职调查主要看哪些方面？我们需要准备什么材料？",
  "纯IP出资和现金+IP混合出资哪种更好？对赌协议要注意什么？",
]

const CAPABILITIES = [
  { icon: PieChart, label: '作价入股', description: 'IP出资流程', color: '#F59E0B' },
  { icon: Scale, label: '价值评估', description: '公允价值认定', color: '#EF4444' },
  { icon: Handshake, label: '交易结构', description: '股权/混合/对赌', color: '#22C55E' },
  { icon: Users, label: '尽调支持', description: 'IP审查清单', color: '#8B5CF6' },
  { icon: TrendingUp, label: '税务筹划', description: '递延纳税优惠', color: '#06B6D4' },
]
...
const POLICY_HIGHLIGHTS = [
  {
    title: '公司法非货币出资',
    date: '2023年修订',
    content: '非货币财产可作价出资，全体股东货币出资金额不低于注册资本30%',
    color: '#F59E0B',
  },
  {
    title: '财税101号文',
    date: '2016年发布',
    content: '技术入股可选择递延纳税，递延期限最长不超过5年',
    color: '#22C55E',
  },
  {
    title: '科技成果转化规定',
    date: '多部委联合',
    content: '科技成果转化获得的股权奖励，可享受个人所得税优惠',
    color: '#8B5CF6',
  },
]

export default function IPEquity() {
  ...
  const sendMessage = async (content: string) => {
    ...
    try {
      ...
      const response = await fetch('/api/ip-equity-agent', {
        method: 'POST',
      ...
      <div className="flex flex-col h-[calc(100vh-56px)]">
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-[var(--navy-700)]">
          <div className="flex items-center gap-2 text-sm">
            ...
            <ChevronRight size={14} className="text-[var(--navy-600)]" />
            <span className="text-[var(--text-primary)] font-medium">股权融资</span>
          </div>
            ...
            <div className="flex flex-col items-center justify-center h-full px-6">
              ...
              >
                ...
                <p className="text-sm text-[var(--text-secondary)] mb-8">
                  以IP资产为核心的股权融资方案设计，涵盖作价入股、技术入股税务筹划、投资人尽调支持全流程服务
                </p>
            ...
            <div className="flex items-end gap-3">
              ...
              <div className="flex-1 relative">
                <textarea
                  ...
                  placeholder="输入您的股权融资需求，例如：咨询作价入股流程、技术入股税务筹划、尽调材料准备..."
                  rows={1}
